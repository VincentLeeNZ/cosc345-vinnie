...
int Stock::getOutstanding() const
{
    return outstanding;
}

int Stock::getIpoYear() const
{
    return ipoYear;
}
...
std::string Stock::getIndustry() const
{
    return industry;
}
...
void Stock::setOutstanding(int outstanding)
{
    this->outstanding = outstanding;
}

void Stock::setIpoYear(int ipoYear)
{
...
void Stock::setIndustry(const std::string &industry)
{
...
double Stock::getPriceAtDate(const std::string &date) const
{
    for (const StockHistory &entry : history)
    {
        if (entry.date == date)
        {
